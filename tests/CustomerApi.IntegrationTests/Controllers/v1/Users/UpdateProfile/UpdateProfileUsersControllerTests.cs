...
namespace CustomerApi.IntegrationTests.Controllers.Users.UpdateProfile;

[IntegrationTest]
public class UpdateProfileUsersControllerTests : ControllerTestsBase
{
    private const string Endpoint = "/api/users/profile";
